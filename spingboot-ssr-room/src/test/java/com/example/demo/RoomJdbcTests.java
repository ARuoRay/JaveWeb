...
public class RoomJdbcTests {
	...
	public void testRoomAdd() {
		Room room=new Room(101,"101(S)",5);
		int rowcount=roomRepositoryJdbc.save(room);
		System.out.println("測試新增:"+room+"結果回傳:"+rowcount+"(1表示正確新增一筆)");
	}
	...
	public void updateRoom() {
		...
		System.out.println("測試修改"+uptRoom+"結果回傳"+rowcount+"(1表示正確修改一筆)");
	}
	...
	public void deleteRoom() {
		...
		System.out.println("測試刪除:"+roomId+"結果回傳:"+rowcount+"(1表示刪除修改一筆)");
	}
